...
Some minor changes + Google App Engine Plugin

@git clone git://github.com/mikkolehtinen/oh-my-zsh.git ~/.oh-my-zsh@

A handful of functions, auto-complete helpers, and stuff that makes you shout...

h2. adding Vim plugins

Example:
@git submodule add https://github.com/wavded/vim-stylus.git vim/bundle/vim-stylus@
